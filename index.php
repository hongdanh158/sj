<?php include('header.php') ?>
	<section class="banner">
		...
		<div class="arrow arrow-left"><i class="material-icons dp48">arrow_back</i></div>
		<div class="arrow arrow-right"><i class="material-icons dp48">arrow_forward</i></div>
	</section>
	<script>
		$('.slick-slider').slick({
			autoplay: true,
